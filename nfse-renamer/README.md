# JB Renamer - Renomeador Inteligente de NFS-e

O **JB Renamer** é um aplicativo web premium, responsivo e extremamente veloz projetado para automatizar a padronização e renomeação de Notas Fiscais de Serviço Eletrônicas (NFS-e) em lote.

Desenvolvido para profissionais da área fiscal e contábil, ele elimina o trabalho manual e repetitivo de abrir PDFs individuais para descobrir dados fiscais, renomeando dezenas de arquivos de uma só vez a partir de padrões totalmente customizáveis.
